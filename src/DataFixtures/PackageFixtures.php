    ...
    public function load(ObjectManager $manager)
    {
        ...
        // Trading
            ...
            $package
                ->setVendor('tentacle')
                ->setPublic(true)
                ->setName('daily_trading_mode')
                ->setDescription('A  public "Utility" tentacles (packages) for the OctoBot project evaluator.')
                ->setWebsite('https://github.com/Drakkar-Software')
                ->setCategory($this->getReference(PackageCategoryFixtures::TRADING_MODE_REFERENCE))
                ->setVersion('1.0.0')
                ->setRepository('https://github.com/Drakkar-Software/OctoBot-Tentacles/blob/master/TA/daily_trading_mode.py');
            $manager->persist($package);
            ...
            $package
                ->setVendor('tentacle')
                ->setPublic(true)
                ->setName('high_frequency_mode')
                ->setDescription('A  public "Utility" tentacles (packages) for the OctoBot project evaluator.')
                ->setWebsite('https://github.com/Drakkar-Software')
                ->setCategory($this->getReference(PackageCategoryFixtures::TRADING_MODE_REFERENCE))
                ->setVersion('1.0.0')
                ->setRepository('https://github.com/Drakkar-Software/OctoBot-Tentacles/blob/master/TA/high_frequency_mode.py');
            $manager->persist($package);
            ...
            $package
                ->setVendor('tentacle')
                ->setPublic(true)
                ->setName('investor_mode')
                ->setDescription('A  public "Utility" tentacles (packages) for the OctoBot project evaluator.')
                ->setWebsite('https://github.com/Drakkar-Software')
                ->setCategory($this->getReference(PackageCategoryFixtures::TRADING_MODE_REFERENCE))
                ->setVersion('1.0.0')
                ->setRepository('https://github.com/Drakkar-Software/OctoBot-Tentacles/blob/master/TA/investor_mode.py');
            $manager->persist($package);
            ...
            $package
                ->setVendor('tentacle')
                ->setPublic(true)
                ->setName('objective_mode')
                ->setDescription('A  public "Utility" tentacles (packages) for the OctoBot project evaluator.')
                ->setWebsite('https://github.com/Drakkar-Software')
                ->setCategory($this->getReference(PackageCategoryFixtures::TRADING_MODE_REFERENCE))
                ->setVersion('1.0.0')
                ->setRepository('https://github.com/Drakkar-Software/OctoBot-Tentacles/blob/master/TA/objective_mode.py');
            $manager->persist($package);
            ...
            $package
                ->setVendor('tentacle')
                ->setPublic(true)
                ->setName('opportunity_mode')
                ->setDescription('A  public "Utility" tentacles (packages) for the OctoBot project evaluator.')
                ->setWebsite('https://github.com/Drakkar-Software')
                ->setCategory($this->getReference(PackageCategoryFixtures::TRADING_MODE_REFERENCE))
                ->setVersion('1.0.0')
                ->setRepository('https://github.com/Drakkar-Software/OctoBot-Tentacles/blob/master/TA/opportunity_mode.py');
            $manager->persist($package);
            ...
            $package
                ->setVendor('tentacle')
                ->setPublic(true)
                ->setName('safe_profit_mode')
                ->setDescription('A  public "Utility" tentacles (packages) for the OctoBot project evaluator.')
                ->setWebsite('https://github.com/Drakkar-Software')
                ->setCategory($this->getReference(PackageCategoryFixtures::TRADING_MODE_REFERENCE))
                ->setVersion('1.0.0')
                ->setRepository('https://github.com/Drakkar-Software/OctoBot-Tentacles/blob/master/TA/safe_profit_mode.py');
            $manager->persist($package);
