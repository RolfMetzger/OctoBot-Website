 ...
 */
final class Version20180614142436 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tbl_package ADD public BOOLEAN DEFAULT \'false\' NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER SEQUENCE tbl_package_category_id_seq INCREMENT BY 1');
        $this->addSql('ALTER SEQUENCE tbl_package_id_seq INCREMENT BY 1');
        $this->addSql('ALTER TABLE tbl_package DROP public');
    }
}
