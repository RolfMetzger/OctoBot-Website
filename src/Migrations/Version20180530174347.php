 ...
 */
final class Version20180530174347 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE package (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, vendor VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, version VARCHAR(25) NOT NULL, description LONGTEXT DEFAULT NULL, repository VARCHAR(255) DEFAULT NULL, website VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_DE68679512469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
